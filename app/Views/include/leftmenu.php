...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <span class="ms-1 font-weight-bold" style="color: rgb(209, 171, 101);  display: inline-block; text-align: center; width: 100%;"><?= session()->get('username') ?></span>
      <ul class="navbar-nav">
        <li class="nav-item">
        <a class="nav-link active" href=" <?= site_url('anasayfa') ?>">
          ...
          <!-- 
        <li class="nav-item">
        <a class="nav-link" href=" <?= site_url('siparisgir') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= site_url('firmaanaliz') ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Firma Analiz</span>
          </a>
    </li>
<?php endif; ?>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/virtual-reality.html">
            ...
            <span class="nav-link-text ms-1">Bilezik Sipariş</span>
          </a>
        </li>
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none"><a href="<?= base_url('logout') ?>">Çıkış Yap</a></span>
              </a>
            </li>
